...
windows-x86_64-CC	  := i686-w64-mingw32-gcc
windows-x86_64-CXX	  := i686-w64-mingw32-g++
windows-x86-FLAGS	  += -m32
windows-x86_64-FLAGS  += -m64
windows-CPPFLAGS	  += -O2 -D_WIN32_WINNT=0x0500 -DUNICODE
windows-LDFLAGS		  += -Xlinker -subsystem=windows -lglew32 -lgdi32 -lopengl32
...
$(foreach p,$(platform), $(foreach a,$($p-arch), $(eval $(call rules,$p,$a))))
